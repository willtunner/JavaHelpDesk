 ...
 * @author WillTunner
 */
public class Lista_ChamadosMes extends javax.swing.JFrame {

    public Lista_ChamadosMes(String userLogado3) {
        initComponents();
        ListaChamadosMes(userLogado3);
    ...
    private Lista_ChamadosMes() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void ListaChamadosMes(String user) {
        ...
        String dataMes = simpleDateFormat.format(mes.getTime());

        for (Chamado c : cadao.ListarChamadoMes(user, dataMes, dataAtual)) {
    ...
    private void initComponents() {
        ...
        lbl_ChamadosTit.setText("Chamados em um mês");

        javax.swing.GroupLayout HeadLayout = new javax.swing.GroupLayout(Head);
        Head.setLayout(HeadLayout);
        HeadLayout.setHorizontalGroup(
            HeadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_ChamadosTit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1204, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_ChamadosMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_ChamadosMes().setVisible(true);
            }
        });
    }
