 ...
 * @author WillTunner
 */
public final class Lista_ChamadosSemana extends javax.swing.JFrame {

    public Lista_ChamadosSemana(String userLogado3) {
        initComponents();
        ListaChamadosSemana(userLogado3);
    ...
    private Lista_ChamadosSemana() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void ListaChamadosSemana(String user) {
        ...
        String dataSemana = simpleDateFormat.format(Semana.getTime());

        for (Chamado c : cadao.ListarChamadoSemana(user, dataSemana, dataAtual)) {
        ...
        public void mouseClicked(MouseEvent evt) {
            if (evt.getClickCount() == 2) {
                try {
                    ...
                    Logger.getLogger(Lista_ChamadosDia.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Chamados em uma semana");

        BasePanel.setPreferredSize(new java.awt.Dimension(1180, 800));
        ...
        lbl_ChamadosTit.setText("Chamados em uma semana");

        javax.swing.GroupLayout HeadLayout = new javax.swing.GroupLayout(Head);
        Head.setLayout(HeadLayout);
        HeadLayout.setHorizontalGroup(
            HeadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_ChamadosTit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(BasePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 1204, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(BasePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 710, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_ChamadosSemana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_ChamadosSemana().setVisible(true);
            }
        });
    }
