 ...
 * @author WillTunner
 */
public final class Lista_ChamadosDia extends javax.swing.JFrame {

    //Chama a tela chamado
    ...
    //==================================
    public Lista_ChamadosDia(String userLogado) {
        initComponents();
        ListaChamadosDia(userLogado, dataAtual);
    ...
    private Lista_ChamadosDia() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public  void ListaChamadosDia(String user, String dataAtual) {
        ...
        for (Chamado c : cadao.ListarChamado(user, dataAtual)) {
    ...
    private void initComponents() {
        ...
        lbl_ChamadosTit.setText("Chamados Hoje");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_ChamadosDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_ChamadosDia().setVisible(true);
            }
        });
    }
